...
[Skill]
select="SELECT id, code, name, description, expansionId "
...
[Survivor]
select="SELECT id, name, standard, zombivor, ultimate, ultimatez, expansionId, background, altImgName, liveAble "
