...
[Expansion]
select="SELECT id, code, name, displayRank, nbSurvivants, nbMissions "
from="FROM wp_11_zombicide_expansion "
where="WHERE code LIKE '%s' AND nbMissions >= '%s' AND nbSurvivants >= '%s' "
insert="INSERT INTO wp_11_zombicide_expansion (code, name, displayRank, nbSurvivants, nbMissions) VALUES ('%s', '%s', '%s', '%s', '%s');"
update="UPDATE wp_11_zombicide_expansion SET code='%s', name='%s', displayRank='%s', nbSurvivants='%s', nbMissions='%s' "
[Keyword]
...
[Skill]
select="SELECT id, code, name, description, official "
from="FROM wp_11_zombicide_skill "
where="WHERE code LIKE '%s' AND name LIKE '%s' AND description LIKE '%s' AND official LIKE '%s' "
insert="INSERT INTO wp_11_zombicide_skill (code, name, description, official) VALUES ('%s', '%s', '%s', '%s');"
update="UPDATE wp_11_zombicide_skill SET code='%s', name='%s', description='%s', official='%s' "
[Spawn]
